...
namespace GridMvc.Pagination
{
    ...
    public class GridPager : IGridPager
    {
        ...
        /*Custom Modification By Arsalan :: 06/10/2016*/
        public virtual string GetLinkForExporter(string docType)
        {
            return _queryBuilder.GetQueryStringWithParameter("export-to",docType.ToLower());
        }
