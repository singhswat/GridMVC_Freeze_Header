...
namespace GridMvc.Html
{
    ...
    public class GridHtmlOptions<T> : IGridHtmlOptions<T> where T : class
    {
        ...
        public IGridHtmlOptions<T> TableId(string tableId)
        {
            _source.RenderOptions.TableId = tableId;
            return this;
        }

        public IGridHtmlOptions<T> SetRowAtr(Func<T, string> contraint)
        {
            _source.SetRowAtrContraint(contraint);
            return this;
        }
