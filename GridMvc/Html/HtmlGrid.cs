...
namespace GridMvc.Html
{
    ...
    public class HtmlGrid<T> : GridHtmlOptions<T>, IGrid where T : class
    {
        ...
        string IGrid.GetRowAtr(object item)
        {
            return _source.GetRowAtr(item);
        }

        bool IGrid.IsExport {get { return _source.IsExport; }}
        string IGrid.ExportUrl{get { return _source.ExportUrl; }}
    }
}