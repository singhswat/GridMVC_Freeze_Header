...
namespace GridMvc
{
    ...
    public class Grid<T> : GridBase<T>, IGrid where T : class
    {
        ...
        private readonly ExportGridItemsProcessor<T> _currentExportItemsProcessor; //By Arsalan 
            ...
            : base(items)
        {
            ...
            _currentExportItemsProcessor = new ExportGridItemsProcessor<T>(this, _settings.ExportSettings);
